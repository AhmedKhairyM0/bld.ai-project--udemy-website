...
function SidebarContainer() {
  ...
  return (
    <section className={styles.sideBarContainer}>
      <button className={styles.sideBarIntro} onClick={0}>
        <img
      ...
      <div className={styles.sideBarBody}>
        ...
        <Typography className={styles.saleDays}>🕑 1 day left at this price</Typography>
        <button className={`${styles.cartBtn} ${styles.btn}`}>Add to cart</button>
        ...
        <div className={styles.courseIncludes}>
          ...
          <IconLabeledComponent icon={<LiveTvIcon />} label={"14 hours on-demand video"}/>
          <IconLabeledComponent icon={<ArticleIcon />} label={"1 article"}/>
          <IconLabeledComponent icon={<SimCardDownloadIcon />} label={`3 downloadable resources`}/>
        </div>
        <div>
